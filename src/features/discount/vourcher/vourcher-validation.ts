      ...
      .refine(
        (data) =>
          data.usageType === "CART_TOTAL" || data.valueType === "PERCENTAGE"
            ...
            : true,
        {
          message: "Max discount amount is required for CART_TOTAL usage or PERCENTAGE value type",
          path: ["maxDiscountAmount"],
        },
      )
      .refine(
        (data) => (data.usageType === "PRODUCT_SPECIFIC" ? data.productId !== undefined : true),
        {
